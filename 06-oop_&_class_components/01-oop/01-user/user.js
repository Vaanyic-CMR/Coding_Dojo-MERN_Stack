class User {
    ...
    displayBalance() { console.log( `User: ${this.name}, Balance: $${this.accountBalance}` ); };
...
user1.makeDeposit(50).makeDeposit(200).makeDeposit(300).makeWithdrawl(500);
user1.displayBalance();

user2.makeDeposit(50).makeDeposit(200).makeWithdrawl(20).makeWithdrawl(30);
user2.displayBalance();

user3.makeDeposit(500).makeWithdrawl(100).makeWithdrawl(150).makeWithdrawl(50);
